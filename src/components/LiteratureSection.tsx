...
बाँझो छाडि छाडि।`;
  ...
  const essayMessage = `In our society, when any birds approach nearer to you or get trapped inside your house, it is thought that it has some message. I came to realize this after I posted a picture of 'the bird on my window' on Instagram. After that, my mind asked me continuously about the message. But I found nothing. After seeing a comment from Nabina didi on my Instagram post with this picture, suggesting that there might be a deeper message behind it, I started to feel the same and that thought began to form in my mind.
