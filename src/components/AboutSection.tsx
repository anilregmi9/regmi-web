          ...
          <div className="mt-12 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="mt-10 max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
              ...
              <Card className="shadow-soft overflow-hidden">
                ...
                <CardContent className="p-4 text-center">
                  <p className="text-sm text-muted-foreground italic">Geology department in TC</p>
                </CardContent>
              </Card>
              <Card className="shadow-soft overflow-hidden">
                <div className="aspect-[16/10] overflow-hidden">
                ...
                <CardContent className="p-4 text-center">
                  <p className="text-sm text-muted-foreground italic">Classmates</p>
                </CardContent>
              </Card>
            </div>
          </div>
